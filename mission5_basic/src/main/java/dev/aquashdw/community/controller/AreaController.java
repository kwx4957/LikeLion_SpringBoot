...
public class AreaController {
    ...
    public ResponseEntity<AreaDto> readAroundArea(@RequestParam("latitude") double latitude, @RequestParam("longitude") double longitude){
        logger.info("{}",this.areaService.readAroundArea(latitude,longitude));
        return ResponseEntity.ok(this.areaService.readAroundArea(latitude,longitude));
    }
}
